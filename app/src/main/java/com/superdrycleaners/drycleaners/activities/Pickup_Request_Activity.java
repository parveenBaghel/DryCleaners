...
public class Pickup_Request_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pickup__request);
        ...
        viewController(mobileNumber, email, name, address, userID);
    }

    private void viewController(final String mobileNumber, final String email, final String name, final String address, final String userID) {

        final AppCompatTextView dateText = findViewById(R.id.date_text);
        timeText = findViewById(R.id.time_text);
        final EditText pickup_remark = findViewById(R.id.pickup_remark);
        // EditText offer_edit = findViewById(R.id.offer_edit);
        ...
        findViewById(R.id.setDate).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(Pickup_Request_Activity.this,
        ...
        findViewById(R.id.timePicker).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                CustomTimePickerDialog customTimePickerDialog = new CustomTimePickerDialog(Pickup_Request_Activity.this, timeSetlistner, hour, minute, false);
        ...
        findViewById(R.id.pickupSubmit_BTN).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String str_remark = pickup_remark.getText().toString().trim();
                ...
                /*else if (pickup_remark.getText().toString().isEmpty()) {
                    pickup_remark.setError("Enter Remark");
                }*/
                else {
                    ...
                    try {
                        ...
                        jsonObject.put("pickup_date", str_date);
                        jsonObject.put("pickup_time", str_time);
                        jsonObject.put("remark", str_remark);

                        sqLiteDB db = new sqLiteDB(Pickup_Request_Activity.this);
                        ...
                        jsonObject2.put("jobData", jsonArray);
                        jsonObject2.put("userData", jsonArray1.put(jsonObject));
    ...
    private void pickuRequestService(JSONObject data) {
        ...
        final ProgressDialog pd = new ProgressDialog(Pickup_Request_Activity.this);
        ...
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(
                Request.Method.POST, ConfigClass.PICKUP, data,
    ...
    private void successMessage() {
        ...
        alertDialogBuilder.setMessage("Your pickup request Successfully submitted in My Pickup List section...!");
        alertDialogBuilder.setPositiveButton("OK",
                new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface arg0, int arg1) {
                        startActivity(new Intent(Pickup_Request_Activity.this, MainActivity.class));
                        Pickup_Request_Activity.this.finish();
                        sqLiteDB db = new sqLiteDB(Pickup_Request_Activity.this);
                        db.deleteCartTable();
                    }
                });
